...
function setBalance(iBalance, iBalanceSecret) {
  ...
  txtBalance.innerHTML = '';

  var spanBalance = document.createElement("span");
  spanBalance.innerText = iBalance.toLocaleString();
  if (iBalance < 0) { spanBalance.style.color = "red"; }
  txtBalance.appendChild(spanBalance);
