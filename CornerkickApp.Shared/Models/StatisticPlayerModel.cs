...
{
  public class StatisticPlayerModel : LayoutModel
  {
    public int iNation { get; set; }
    public List<SelectListItem> ddlNations { get; set; } = new List<SelectListItem>();

    public int iFormation { get; set; }
    public List<SelectListItem> ltsFormations { get; set; } = new List<SelectListItem>();

    public string[][] sPlayerSkillBest { get; set; }

    public List<SelectListItem> ddlFilterCup { get; set; } = new List<SelectListItem>();
    public int iFilterCup { get; set; }

    public List<SelectListItem> ddlFilterLand { get; set; } = new List<SelectListItem>();
    public int iFilterLand { get; set; }

    public List<SelectListItem> ddlFilterLeague { get; set; } = new List<SelectListItem>();
    public int iFilterLeague { get; set; }

    public List<SelectListItem> ddlFilterClub { get; set; } = new List<SelectListItem>();
